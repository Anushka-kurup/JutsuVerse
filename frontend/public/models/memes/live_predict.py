...
Uses MediaPipe Holistic (pose + both hands), matching capture_clips.py --
arm position is real signal here, not just hand shape, so mog/dab get a
fair shot at being recognized instead of being structurally invisible.
