...
live_predict.py. Built on MediaPipe Holistic (pose + both hands), not just
Hands -- gestures like mog (flexed bicep) and dab (arm angled across the
body) are defined by ARM position, which hand-only landmarks never carried
any information about, no matter how much training data you throw at them.
